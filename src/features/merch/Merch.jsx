  ...
  return (
    <div className="pt-24 pb-20 px-6 max-w-7xl mx-auto space-y-12 animate-fadeIn">
      ...
      {checkoutStep === 'payment' && (
        <div className="max-w-xl mx-auto border border-strikers-border bg-strikers-gray p-8 rounded-3xl space-y-6 text-center">
          <div className="space-y-2">
      ...
      {selectedProduct && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="border border-strikers-border bg-strikers-gray rounded-3xl max-w-lg w-full overflow-hidden relative">
            <button
      ...
      {isCartOpen && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex justify-end">
          <div className="w-full max-w-md bg-strikers-gray border-l border-strikers-border h-full flex flex-col justify-between p-8 relative">
            <button
